...
GRANT EXECUTE ON PROCEDURE project_ARMS.add_marks TO 'arms_lecturer'@'localhost';
GRANT EXECUTE ON PROCEDURE project_ARMS.mark_attendance TO 'arms_lecturer'@'localhost'; 
...
GRANT EXECUTE ON PROCEDURE project_ARMS.mark_attendance TO 'arms_to'@'localhost'; 

-- 4. Student (Read-only access to own data)
CREATE USER 'arms_student'@'localhost' IDENTIFIED BY 'Student@000';
GRANT SELECT ON project_ARMS.student_grade_summary TO 'arms_student'@'localhost'; 
GRANT SELECT ON project_ARMS.student_attendance_summary TO 'arms_student'@'localhost'; 
